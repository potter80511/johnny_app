...
import { CreateRideCheckedInPayload, NetRideCheckedInData } from 'src/features/ride_check_in/types/net';
  ...
  if (req.method === 'POST') {
    ...
    try {
      ...
      try {
        ...
        const data = Array.isArray(rows) && rows.length > 0 ? rows[0] as NetRideCheckedInData : null
